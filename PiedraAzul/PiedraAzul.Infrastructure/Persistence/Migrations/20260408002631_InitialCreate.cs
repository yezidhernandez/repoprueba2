        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientType = table.Column<string>(type: "character varying(13)", maxLength: 13, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenHashed = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingWindowWeeks = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientUserId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                    PatientGuestId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_TokenHashed",
                table: "RefreshTokens",
                column: "TokenHashed",
                unique: true);
